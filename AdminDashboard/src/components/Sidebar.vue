<template>
  <div class="flex">
    <!-- Backdrop -->
    <div
      :class="sideBarOpen ? 'block' : 'hidden'" @click="toggleSidebar()"
    ...
    >
      <div class="flex items-center justify-center mt-8">
        <div class="flex items-center">
          <svg
            class="w-8 h-8 ml-2 text-blue-600"
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
          ...
          <span class="mx-2 text-2xl font-semibold text-white">Text To Speech</span>
        </div>
      </div>
      ...
      <nav class="mt-10">
        ...
        <router-link
          ...
          :class="[$route.name === 'convert' ? activeClass : inactiveClass]"
          to="/convert"
        >
          ...
          <span class="mx-4">Add Text To Speech</span>
        </router-link>

        <router-link
          class="flex items-center px-6 py-2 mt-4 duration-200 border-l-4"
          :class="[$route.name === 'listconvert' ? activeClass : inactiveClass]"
          to="/listconvert"
        >
          ...
          <span class="mx-4">Manager TTS</span>
        </router-link>
        ...
        <a
          ...
          href="https://github.com/nhatbien"
        >
          <svg
